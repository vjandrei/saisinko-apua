export default {
  en: {
    ...
    text: {
      ...
      step1:
        "Kirjoita kylttiin, millaista apua tarvitset (esim. kaupassa tai apteekissa käynti)",
      step2: "Ripusta kyltti kotiovesi ulkopuolelle",
      step3:
        "Kun naapuri ilmoittautuu avuksi, sopikaa, miten apu (esim. kauppalasku) hoidetaan.",
      aboutParagraphy1:
        "Elämme suljettujen ovien takana, emmekä aina edes tiedä, kuka seinän takana asuu. Miten siis voisimme tietää, kuka saattaisi tarvita apua tai keneltä sitä saada?",
      aboutParagraphy2:
        "Idea Saisinko apua? -kyltteihin syntyi kun Andreaksen naapurissa asuva perhe joutui karanteeniin isän palattua matkoilta. Andreas alkoi pohtia, miten voisi saada tietoa muistakin kotitalossaan apua tarvitsevista, itselleen tuntemattomista ihmisistä.",
      aboutParagraphy3:
        "Saatuaan idean hotellien käytössä olevien Älä häiritse -kylttien soveltamisesta Andreas jakoi ajatuksensa LinkedInissä. Ideaan tarttui ensimmäisenä Grano, joka halusi hoitaa Saisinko apua? -kylttien painatuksen ja jakelun kaikkialle Suomeen.",
      team: "Tiimi",
      teamAbout: "Olemme tässä projektissa vapaaehtoisesti",
      volunteering: "Vapaaehtoinen ❤️",
      tanja: "Graafinen suunnittelija",
      andreas: "Idean kehittäjä sekä koodari",
      saija: "Sisältösuunnittelija",
